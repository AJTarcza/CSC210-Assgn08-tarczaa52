...
public class MainActivityFragment extends Fragment {
   ...
   private String correctAnswer; // correct sign for the current sign
   private Set<String> signNameSet;  //set of sign names
   ...
   public void resetQuiz() {
      ...
      try {
         // loop through the assets folder

         String[] names = assets.list("Signs");

         for (String signs : names) {
               fileNameList.add(signs.replace(".png", "").replace("_", " "));
         }
      }
   ...
   private void loadNextSign() {
      ...
      try (InputStream stream =
                   assets.open("Signs" + "/" + nextImage.replace(" ", "_") + ".png")) {
   ...
   // parses the sign sign file name and returns the sign name
